...
namespace Compiler_Theory
{
    public class CompilerScanner
    {
        ...
        /// <returns></returns>
        public List<KeyValuePair<string, string>> GetScannerData(List<KeyValuePair<string, string>> SD, ref bool NoError)
        {
            ...
            {
                if (Data.Value == TokenType.Error.ToString())
                {
                    NoError = false;
                    return new List<KeyValuePair<string, string>>();
                }
                if (Data.Value != TokenType.Comment.ToString())
                {
